#ifndef triumf_elastic_cxx
#define triumf_elastic_cxx
...
// Already defined in do_simu.cxx
...
void do_simu_elastic(const std::string& beam, const std::string& target, const std::string& light, const std::string& heavy, int neutronPS, int protonPS, double Tbeam, double Ex, bool inspect)
{
    // Ex = 0.435;
    ...
    srim->ReadTable("light", "../SRIM files/2H_900mb_CF4_90-10.txt");
    srim->ReadTable("beam", "../SRIM files/11Li_900mb_CF4_90-10.txt");
    srim->ReadTable("heavy", "../SRIM files/11Li_900mb_CF4_90-10.txt");
    srim->ReadTable("lightInSil", "../SRIM files/2H_silicon.txt");
    ...
    // File to save data
    TString fileName {
        TString::Format("../Outputs/%.1fMeV/elastic_TRIUMF_Eex_%.3f_nPS_%d_pPS_%d.root", Tbeam / 11, Ex, neutronPS, protonPS)};
